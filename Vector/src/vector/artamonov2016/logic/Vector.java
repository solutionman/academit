...
public class Vector {
    ...
    public Vector(int n) {
        try {
            ...
            if (n < 0) {
                System.out.print("Can't create such vector, the number must be a positive number.");
            }
        }
    }
    ...
    public Vector(Vector forCopy) {
        ...
        //this.components = System.arraycopy(forCopy.components);
    ...
    public int getSize() {
        if (components == null) {
            System.out.println("Can't get size of this object.");
            return -1;
        }
